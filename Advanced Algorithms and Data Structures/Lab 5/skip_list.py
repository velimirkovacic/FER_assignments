...
class SkipList:
    ...
    def insert(self, value: int) -> None:
        ...
        pred_node.pointers[0] = new_node

        razina = 1

        while razina < level:
            
            if len(pred_node.pointers) > razina:
                new_node.pointers[razina] = pred_node.pointers[razina]
                pred_node.pointers[razina] = new_node
                razina += 1
            else:
                while len(pred_node.pointers) - 1 < razina:
